...
struct MugshotShareTests {
    ...
    @Test func profileLinksNormalizeUsernamesAndPreserveLegacyTokens() {
        ...
        #expect(MugshotProfileSharedLinkRoute.resolve(URL(string: "https://example.com/profile/joe")!, publicBaseURL: base) == nil)
        #expect(MugshotProfileSharedLinkRoute.resolve(URL(string: "https://mugshotapp.co/profile/jo")!, publicBaseURL: base) == nil)
        #expect(MugshotProfileSharedLinkRoute.resolve(URL(string: "https://mugshotapp.co/profile/joe/extra")!, publicBaseURL: base) == nil)
    }
