...
| [People discovery implementation spec](PEOPLE_DISCOVERY_IMPLEMENTATION_SPEC.md) | Planned Contacts and six friend-discovery improvements, screens, states, contracts, privacy and measurement |
