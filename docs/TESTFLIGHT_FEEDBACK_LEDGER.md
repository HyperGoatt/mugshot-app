...
| 56 | `AAoc1b4qRo1mZtAgBjy4ZrI` | Open feedback, 2026-09-10; owner override 2026-09-16 | Make caption text as bold as the drink name | Follow-up | Owner reversed the requested styling; build 8 restores regular rendering and matching regular truncation metrics in Feed and detail | Yes | Generic compile plus seven focused presentation-policy tests passed; signed build-8 candidate launched on the connected iPhone | TestFlight acceptance pending | Open |
