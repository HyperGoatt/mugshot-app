-- Raw recipe reads retain the explicit recipient boundary and apply the same
-- live account, suspension, profile screening and block checks as projection.
-- Owner access remains available; Private recipes never require screening.
