...
do $$ begin
 ...
 and subject_id='00000000-0000-4000-8000-000000000102' and state='pending'
...
set local role anon;
do $$ begin
 if public.get_profile_link_v1('@alpha_fixture_2') is not null then raise exception 'pending website exposed';end if;
end $$;
reset role;
select pg_temp.approve_shared_fixture('user','00000000-0000-4000-8000-000000000102');
set local role anon;
