...
private enum PrivacyDocument {
    static let sections = [
        ...
        ("Content moderation", "Mugshot checks shared text against basic blocked terms. Shared photos, posts, comments, and profiles can be reported for human review. You can block abusive accounts. Private journal entries and private notes are excluded."),
        ("External processing", "Mugshot does not send content to OpenAI. Reports, review decisions, and appeals are handled by Mugshot."),
