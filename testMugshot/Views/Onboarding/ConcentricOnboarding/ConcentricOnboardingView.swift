...
//  testMugshot
//
//  Active implementation of ConcentricOnboarding for animated onboarding flow.
        ...
        return ZStack {
            if pageContents.count > 0 {
                pageContents[currentIndex].view
                    ...
                    .offset(
                        x: isAnimated ? coeff * maxXOffset : 0,
                        y: isAnimated ? maxYOffset : 0
                    )
                    .animation(isAnimated ? fullAnimation : .none, value: isAnimated)
            }
            ...
            if pageContents.count > 1 {
                pageContents[nextIndex].view
                    ...
                    .offset(
                        x: isAnimated ? 0 : -coeff * maxXOffset,
