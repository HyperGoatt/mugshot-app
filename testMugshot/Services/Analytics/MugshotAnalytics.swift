...
enum MugshotHomeWorkbenchAnalyticsAction: String {
    ...
    case guidedChosen = "guided_chosen"
    case quickChosen = "quick_chosen"
    case recipeSelected = "recipe_selected"
    case methodSelected = "method_selected"
    case freeSetupSelected = "free_setup_selected"
    case preparationStarted = "preparation_started"
    case preparationCompleted = "preparation_completed"
    case preparationSkipped = "preparation_skipped"
    case preparationResumed = "preparation_resumed"
    case changesUsed = "changes_used"
    case changesSkipped = "changes_skipped"
    case privateResultSavedRated = "private_result_saved_rated"
    case privateResultSavedUnrated = "private_result_saved_unrated"
    case recipeUpdateOffered = "recipe_update_offered"
    case recipeUpdateAccepted = "recipe_update_accepted"
    case shareOpened = "share_opened"
    case repeatStarted = "repeat_started"
